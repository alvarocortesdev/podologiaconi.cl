...
export default function Home() {
  ...
  return (
    <div className="pb-16 sm:pb-24">
      ...
      <section
        className={clsx(
          "relative bg-background pt-12 pb-16 sm:pt-20 sm:pb-24 lg:pt-32 lg:pb-36 overflow-hidden",
            ...
            {[
              {
                ...
                desc: "Evaluación completa para detectar y tratar patologías.",
              },
              {
                icon: <Leaf size={28} className="text-primary" />,
                title: "Cuidado Integral",
                desc: "Tratamientos que combinan salud y estética para tus pies.",
              },
              {
                icon: <CheckCircle size={28} className="text-primary" />,
                title: "Profesional Certificada",
                desc: "Atención segura y calificada con registro SIS.",
              },
            ].map((feature) => (
              <div
                key={feature.title}
                className="bg-white p-6 sm:p-8 rounded-xl sm:rounded-2xl shadow-sm border border-primary/5 text-center transition-all hover:shadow-lg hover:-translate-y-1"
              >
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10 sm:mb-16">
            <span className="font-bold uppercase tracking-wider text-xs sm:text-sm text-secondary">
              Mi Perfil
            </span>
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10 sm:mb-16">
            ...
            <p className="text-sm sm:text-base text-primary/70 mt-2 sm:mt-3 max-w-2xl mx-auto px-2 sm:px-0">
              Resultados que reflejan la dedicación y profesionalismo en cada
              tratamiento.
            </p>
          </div>
          ...
          <p className="text-center text-xs sm:text-sm text-primary/60 mt-6 sm:mt-8 italic px-2">
            Las imágenes son referenciales y los resultados pueden variar.
          </p>
        </div>
      </section>
        ...
        >
          ...
          >
            ...
            <div className="p-8 overflow-y-auto max-h-[60vh]">
              ...
              <div
                className="text-primary/70 text-sm sm:text-base leading-relaxed prose prose-sm prose-primary max-w-none prose-p:my-2 prose-ul:my-2 prose-ol:my-2 break-words whitespace-normal hyphens-none"
