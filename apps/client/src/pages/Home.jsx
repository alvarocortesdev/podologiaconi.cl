  ...
  return (
    <div className="space-y-20 pb-20">
      ...
      <section className="relative bg-[#f4ede6] overflow-hidden">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-24 lg:flex lg:items-center lg:gap-12">
          {/* Text Content */}
          ...
          <div className="lg:w-1/2 mt-12 lg:mt-0 relative">
            ...
            <div className="relative w-80 h-80 lg:w-[500px] lg:h-[500px] mx-auto rounded-full overflow-hidden border-8 border-white shadow-2xl">
              <img
      ...
      <section id="sobre-mi" className="max-w-4xl mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <h2 className="text-3xl font-bold text-primary mt-2">Formación Académica</h2>
        </div>
        
        <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12 border border-secondary/10 relative overflow-hidden">
      ...
      <section className="bg-primary/5 py-20">
        <div className="max-w-6xl mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-primary">Casos Clínicos</h2>
            <p className="text-gray-600 mt-2">Resultados reales de mis tratamientos</p>
          </div>
          ...
          <div className="flex overflow-x-auto snap-x snap-mandatory gap-6 pb-8 px-4 scrollbar-hide">
            {cases.map((img, idx) => (
              <div 
                key={idx} 
                className="snap-center shrink-0 w-[300px] md:w-[400px] h-[300px] md:h-[400px] rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300"
              >
                <img 
                  src={img} 
